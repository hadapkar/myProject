...
Goal: build the FunTarget game as a **Windows desktop `.exe`** using Flutter (no web hosting required for gameplay UI).
...
- Install Flutter SDK (stable) and enable Windows desktop support.
...
2. Scaffold the Flutter project in this folder and build a first screen:
   ...
   - FunTarget screen (static UI + assets + audio + timer)
