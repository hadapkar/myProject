...
export default class FunTargetAdminLive extends LightningElement {
    ...
    updateSyncedTimer() {
        ...
        const elapsedSeconds = Math.max(0, Math.floor((this.getServerNowMs() - this.spinAnchorMs) / 1000));
        const value = (SPIN_RESULT_SECOND - (elapsedSeconds % ROUND_SECONDS) + ROUND_SECONDS) % ROUND_SECONDS;
